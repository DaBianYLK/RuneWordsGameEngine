...
class SingleStreamVertexDeclaration
{
public:
...
private:
	unsigned short uStreamID;

	std::list<VertexElement> m_listVertexElement;
};

// 如果你想向一个shader同时传递多个顶点流，请使用这个类对顶点流进行声明
class MultiStreamVertexDeclaration
{
public:
...
private:
	std::map<unsigned short, SingleStreamVertexDeclaration> m_mapStreamVertexDeclaration;
};
